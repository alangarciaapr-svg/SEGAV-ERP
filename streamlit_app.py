...
def _page_documentos_empresa_impl():
    ...
    with tab2:
        if df.empty:
            ...
            _add_avail(show, source_df=docs)
            st.dataframe(show, use_container_width=True, hide_index=True)
...
def _page_documentos_empresa_faena_impl():
    ...
    with tab2:
        if docs_periodo.empty:
            ...
            from segav_core.ui import add_availability_column as _add_avail_ef
            _add_avail_ef(show, source_df=docs_periodo)
            st.dataframe(show, use_container_width=True, hide_index=True)
...
def _page_documentos_trabajador_impl():
    ...
    with tab2:
        if docs.empty:
            ...
            from segav_core.ui import add_availability_column as _add_avail_td
            _add_avail_td(show, source_df=docs)
            st.dataframe(show, use_container_width=True, hide_index=True)
